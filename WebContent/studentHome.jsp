		...
		<div class="item">
			<div class="img-fill">
				...
				<div class="text-content">
					...
					<a href="#" class="main-stroked-button">Don't miss the chance</a> <a
						href="#" class="main-filled-button">Assess Yourself</a>
				</div>
			</div>
		</div>
		<!-- // Item -->
		...
		<div class="item">
			<div class="img-fill">
				...
				<div class="text-content">
					...
					<a href="#" class="main-stroked-button">Unlock Your Knowledge</a> <a
						href="#" class="main-filled-button">Assess Yourself</a>
				</div>
			</div>
		</div>
		...
		<div class="item">
			<div class="img-fill">
				...
				<div class="text-content">
					...
					<a href="#" class="main-stroked-button">We quiz therefore we
						are.</a> <a href="#" class="main-filled-button">Assess Yourself</a>
				</div>
			</div>
		</div>
		<!-- // Item -->
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<p style="text-align: justify;">ExamHub.com is first dedicated
					...
					with browser. Exam results can be generated instantly for objective
					type of questions. It can simplify overall examination management
					and result generation activity.</p>
			...
			<br>
			<br> <img src="assets/images/image-gallery/slide_1.jpg" alt=""
